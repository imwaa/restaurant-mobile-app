...
class SearchFilters extends StatefulWidget {
  ...
  final double count = 20; // L'API NE RETOURNE QU'UN MAXIMUM DE 20 RESULTATS
...
class _SearchFiltersState extends State<SearchFilters> {
  /* ----------------------------------------------------
         API FUNCTION POUR RECUPERER LES CATEGORIES
  ---------------------------------------------------*/
                    ...
                    _categories is List<Category>
                        ? Wrap(
                            ...
                            children: List<Widget>.generate(_categories.length,
                              ...
                              final isSelected = _searchOptions.categories
